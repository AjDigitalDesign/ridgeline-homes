...
import { ChevronDown, Video, Play, ExternalLink, Camera, View } from "lucide-react";
import {
  Sheet,
  SheetContent,
  SheetHeader,
...
import type { VideosPage, VideoItem } from "@/lib/api";
...
export default function VideosPageClient({
  ...
  const heroImage = videosPage?.videoBannerImage || "";
  const heroTitle = videosPage?.videoBannerTitle || "Videos";
  const videos = videosPage?.videoItems?.sort((a, b) => a.displayOrder - b.displayOrder) || [];
  ...
  return (
    <main className="min-h-screen bg-gray-50 pt-16 xl:pt-20">
      ...
      <section className="relative h-[300px] lg:h-[400px] overflow-hidden">
        ...
        <div className="absolute inset-0 flex items-center justify-center text-center">
          ...
          >
            ...
            >
              Watch tours of our homes and communities
            </p>
            <div
      ...
      {/* Media Sub-Navigation */}
      <MediaSubNav activeTab="videos" isAnimated={isAnimated} />
      <MobileMediaSubNav />
        ...
        {hasVideos && selectedVideo ? (
          <div className="flex flex-col lg:flex-row gap-8">
            ...
            <div className="lg:flex-2">
              <MainVideoPlayer video={selectedVideo} isAnimated={isAnimated} />
            </div>
          ...
          >
            <div className="relative inline-block">
              <Video className="size-16 text-gray-300 mx-auto mb-4" />
              <Play className="size-6 text-gray-300 absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 mb-4" />
            </div>
            <p className="text-lg text-gray-500">No videos available yet</p>
            <p className="text-sm text-gray-400 mt-1">Check back later for video content</p>
            <Link
              href="/photos"
