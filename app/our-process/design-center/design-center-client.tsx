...
export default function DesignCenterPageClient() {
  ...
  return (
    <main className="min-h-screen bg-gray-50">
      ...
      <section className="relative h-[300px] lg:h-[400px] overflow-hidden">
        ...
        <div className="absolute inset-0 flex items-center justify-center text-center">
          ...
          >
            ...
            >
              Personalize every detail of your new home
            </p>
            <div
      ...
      {/* Process Sub-Navigation */}
      <ProcessSubNav activeTab="design-center" isAnimated={isAnimated} />
      <MobileProcessSubNav />
      ...
      <div className="container mx-auto px-4 lg:px-10 xl:px-20 2xl:px-24 py-8 lg:py-12">
        ...
        >
          <h2 className="text-2xl font-bold text-main-primary mb-2">Design Center</h2>
          <p className="text-gray-500 text-sm mb-8">
            Explore our design options and customize your home
          </p>
        </div>
        ...
        >
          ...
          <p className="text-lg text-gray-500">Design Center information coming soon</p>
          <p className="text-sm text-gray-400 mt-1">
            Check back later for details about our design options
          </p>
          <Link
            href="/our-process"
