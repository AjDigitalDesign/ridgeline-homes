          ...
          <div className="w-full lg:w-1/2">
            ...
            <AnimateOnScroll animation="fade-in-up" delay={200}>
              <h2 className="text-3xl lg:text-4xl xl:text-5xl font-bold text-white leading-tight mb-6">
                The Future of Homebuilding in Maryland
              </h2>
            </AnimateOnScroll>
            ...
            <AnimateOnScroll animation="fade-in-up" delay={300}>
              <p className="text-neutral-100 text-base lg:text-lg mb-6 max-w-lg">
                A cornerstone is the first stone set—the foundation everything
                else builds upon. At Cornerstone Communities, we understand that
                a home is more than walls and windows; it&apos;s where your
                family&apos;s story unfolds. That's why we build neighborhoods
                where connections happen naturally, where morning walks lead to
                lifelong friendships, and where your home&apos;s foundation is
                matched only by the foundation of community around it.
              </p>
            </AnimateOnScroll>

            {/* Shop for Homes Button */}
